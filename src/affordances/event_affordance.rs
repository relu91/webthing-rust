...
#[derive(Debug)]
struct BaseEventAffordance {
    base : Box<dyn InteractionAffordance>,
    subscription : Option<Box<dyn DataSchema>>,
    data : Option<Box<dyn DataSchema>>,
    cancellation : Option<Box<dyn DataSchema>>
}

impl JSonObject for BaseEventAffordance {
